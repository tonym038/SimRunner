...
%    SIMRUNNER_PAR(RUNF, EXPNAME) requires that the main file 'par_main.m' is 
%    on the path and, like 'test_main.m', accepts a structure of inputs 
%    'inputs'. RUNF is the runfile containing the structured array CONSTANT 
%    and vectors of experimental conditions contained in structured array 
%    VARIABLE. EXPNAME is the output .mat file name to save.
%
...
parfor ex = 1:n_ex
    ...
    summary(ex).results = par_main(inputs);
